...
export default class Strawberries extends Component {
  ...
  createDataModel = () => {
    ...
    for (const day of ACISData) {
      ...
      this.props.store.app.setStrawberries({ botrytis, anthracnose });
    }
  };
        ...
        <Flex justify="space-between" wrap>
          <Box mt={3} col={12} lg={5} md={5} sm={12}>
            ...
            <Table
              ...
              dataSource={
                areRequiredFieldsSet
                  ? takeRight(strawberries, 8).map(day => day.botrytis)
                  : null
              }
            />
          </Box>
          ...
          <Box mt={3} col={12} lg={5} md={5} sm={12}>
            ...
            <Table
              ...
              dataSource={
                areRequiredFieldsSet
                  ? takeRight(strawberries, 8).map(day => day.anthracnose)
                  : null
              }
            />
          </Box>
